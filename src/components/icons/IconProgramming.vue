<template>
  <svg height="50px" width="50px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
    ...
    <path id="SVGCleanerId_0" style="fill:#6FA0E3;"
      d="M456,264H24c-8.84,0-16-7.16-16-16v-32h464v32C472,256.84,464.84,264,456,264z" />
    <g>
    ...
    <path id="SVGCleanerId_1" style="fill:#FFFFFF;"
      d="M472,216H8V24c0-8.84,7.16-16,16-16h432c8.84,0,16,7.16,16,16V216z" />
    <g>
      <path id="SVGCleanerId_1_1_" style="fill:#FFFFFF;"
        d="M472,216H8V24c0-8.84,7.16-16,16-16h432c8.84,0,16,7.16,16,16V216z" />
    </g>
    <g>
    ...
    <g>
      ...
      <path style="fill:#4D4D4D;"
        d="M48,400h-8c-4.424,0-8,3.576-8,8s3.576,8,8,8h8c4.424,0,8-3.576,8-8S52.424,400,48,400z" />
      <path style="fill:#4D4D4D;"
        d="M48,432h-8c-4.424,0-8,3.576-8,8s3.576,8,8,8h8c4.424,0,8-3.576,8-8S52.424,432,48,432z" />
      <path style="fill:#4D4D4D;"
        d="M88,416h8c4.424,0,8-3.576,8-8s-3.576-8-8-8h-8c-4.424,0-8,3.576-8,8S83.576,416,88,416z" />
      <path style="fill:#4D4D4D;"
        d="M240,432H88c-4.424,0-8,3.576-8,8s3.576,8,8,8h152c4.424,0,8-3.576,8-8S244.424,432,240,432z" />
      <path style="fill:#4D4D4D;"
        d="M136,416h8c4.424,0,8-3.576,8-8s-3.576-8-8-8h-8c-4.424,0-8,3.576-8,8S131.576,416,136,416z" />
      <path style="fill:#4D4D4D;"
        d="M184,416h8c4.424,0,8-3.576,8-8s-3.576-8-8-8h-8c-4.424,0-8,3.576-8,8S179.576,416,184,416z" />
      <path style="fill:#4D4D4D;"
        d="M240,400h-8c-4.424,0-8,3.576-8,8s3.576,8,8,8h8c4.424,0,8-3.576,8-8S244.424,400,240,400z" />
      <path style="fill:#4D4D4D;"
        d="M288,400h-8c-4.424,0-8,3.576-8,8s3.576,8,8,8h8c4.424,0,8-3.576,8-8S292.424,400,288,400z" />
      <path style="fill:#4D4D4D;"
        d="M288,432h-8c-4.424,0-8,3.576-8,8s3.576,8,8,8h8c4.424,0,8-3.576,8-8S292.424,432,288,432z" />
      <path style="fill:#4D4D4D;"
        d="M328,416h24c4.424,0,8-3.576,8-8s-3.576-8-8-8h-24c-4.424,0-8,3.576-8,8S323.576,416,328,416z" />
      <path style="fill:#4D4D4D;"
        d="M360,432h-32c-4.424,0-8,3.576-8,8s3.576,8,8,8h32c4.424,0,8-3.576,8-8S364.424,432,360,432z" />
      ...
      <path style="fill:#4D4D4D;"
        d="M432,40h-64c-4.424,0-8,3.576-8,8s3.576,8,8,8h64c4.424,0,8-3.576,8-8S436.424,40,432,40z" />
      <path style="fill:#4D4D4D;"
        d="M336,40h-8c-4.424,0-8,3.576-8,8s3.576,8,8,8h8c4.424,0,8-3.576,8-8S340.424,40,336,40z" />
